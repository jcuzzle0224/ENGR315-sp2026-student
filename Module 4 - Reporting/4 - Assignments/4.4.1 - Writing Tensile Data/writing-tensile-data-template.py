from writing_tensile_utils import parse_tensile_file, calculate_max_strength_strain, calculate_elastic_modulus, calculate_stress, calculate_yield_strength, MaterialSample
import os
import sys
